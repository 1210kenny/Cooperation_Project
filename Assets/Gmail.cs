...
public class Gmail
{
    ...
    public Gmail(ChatGPT chatGPT, inputChat inputChat)
    {
    ...
    //GPT訊息 回傳動作 (Email查詢)
    void CallBack_E(string _callback)
    {
        inputChat.print(_callback);
        ...
        {
            AiSpack($"通訊錄中找不到 {MailData.addressee} 的Email，請確認有無正確登錄至通訊錄。");
