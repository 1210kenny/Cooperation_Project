...
if __name__ == '__main__':
    ...
    Vocals = [100, 2000]  # 設定講話的合法頻率範圍, 設成 2000 是因為不想過濾高頻部分.
    # SampleRate = 8000
    SampleRate = 16000
        ...
        try:
            ...
            if not data_queue.empty() :
                ...
                if "2" in mode:
                    ...
                    torchaudio.save(temp_file + 'b.wav', est_sources[:, :, 1].detach().cpu(), SampleRate)
